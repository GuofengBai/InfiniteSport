...
<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
    <div class="row">
        <ol class="breadcrumb">
            ...
            <li class="active">all_activity</li>
        </ol>
    </div><!--/.row-->

    <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">所有活动</h1>
        </div>
    </div><!--/.row-->
            ...
            success: function (result) {
                ...
                for(i=0;i<data.length;i++){
                    var tb="<div class=\"panel panel-teal panel-widget\">"+
                        ...
                        "</div>"+
                        "<div class=\"col-sm-2 col-lg-2 widget-right\">"+
                        "<div class=\"text-muted\">奖励</div>"+
                        "<div class=\"large\">"+data[i].bonus+"</div>"+
                        "</div>"+
                        "<div class=\"col-sm-2 col-lg-2 widget-right\">"+
                    ...
                    "</div>"+
                    "<div class=\"col-sm-2 col-lg-2 widget-right\">"+
                    "<div>"+data[i].description+"</div></div></div></div>";
                    $("#a_list").append(tb);
                }
